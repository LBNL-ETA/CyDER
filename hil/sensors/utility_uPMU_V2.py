...
if __name__ == "__main__":
	#Example code for LBNL
	server = "http://upmu.lbl.gov:9000"
	uuid = "beea4c9c-c5a7-47c3-afb8-8afa956b5553"
	print 'Test of uPMU queries for {}\nat {}'.format(uuid, server)
	print 'Latest value as FMU:', get_latest(uuid, server)
	print 'Latest value as FMU (averge):', get_latest_avg(uuid, server, 1)
