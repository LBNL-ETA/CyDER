...
project = u'FMU Export of the Opal-RT Simulator'
copyright = u'2017, The Regents of the University of California (through Lawrence Berkeley National Laboratory)'
...
html_title = "FMU Export of the Opal-RT Simulator User Guide"
...
latex_documents = [
  ('index', 'userGuide.tex', u'FMU Export of the Opal-RT Simulator',
