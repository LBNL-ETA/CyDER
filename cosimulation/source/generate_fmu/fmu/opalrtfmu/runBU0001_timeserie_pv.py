...
def run_simulator ():
    ...
    # Define the inputs
    simulator_input_names = ['LBNL_test1_sc_console_port1', 'LBNL_test1_sc_console_port2', 'LBNL_test1_sc_console_port3']
    simulator_input_values = [0.0, 0.0, 0.0]
    ...
    #for tim in np.arange(start_time, stop_time, step_size):
        ...
        sim_tim.append(val)
        sleep (1)
        sim_mod.set_real(simulator_input_valref, [ c*x for x in simulator_input_values])
        print(sim_mod.get_real(simulator_output_valref))
