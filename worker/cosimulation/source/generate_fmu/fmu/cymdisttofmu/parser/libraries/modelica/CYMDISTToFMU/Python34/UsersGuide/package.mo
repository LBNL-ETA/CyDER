...
<code>CYMDISTToFMU.Resources/Python-Sources</code>.
...
<pre>
  export PYTHONPATH=${PYTHONPATH}:\"Path_To_CYMDISTToFMU.Library\"/Resources/Python-Sources
  export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:\"Path_To_CYMDISTToFMU.Library\"/Resources/Library/linux32
  </pre>
  <p>
  ...
  <!-- =================================================================== -->
      ...
      <code>CYMDISTToFMU.Resources/Library/linux64</code>.
      To do so, enter on a console the commands
      </p>
<pre>
  export PYTHONPATH=${PYTHONPATH}:\"Path_To_CYMDISTToFMU.Library\"/Resources/Python-Sources
  export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:\"Path_To_CYMDISTToFMU.Library\"/Resources/Library/linux64
  </pre>
  <p>
...
with
<pre>
  export LD_LIBRARY_PATH=$DYMOLA/bin/lib:\"Path_To_CYMDISTToFMU.Library\"/Resources/Library/linux32
  ...
  <!-- =================================================================== -->
    <tr>
      ...
      <td>
        ...
        <code>\"Path_To_CYMDISTToFMU.Library\"\\Resources\\Python-Sources</code>.
      </td>
    </tr>
  <!-- =================================================================== -->
  </table>
...
<p>
The example
<a href=\"modelica://CYMDISTToFMU.Python34.Functions.Examples.Exchange\">
CYMDISTToFMU.Python34.Functions.Examples.Exchange</a>
...
<p>
The example
<a href=\"modelica://CYMDISTToFMU.Python34.Examples.KalmanFilter\">
CYMDISTToFMU.Python34.Examples.KalmanFilter</a>
