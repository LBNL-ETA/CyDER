...
A template named ``CYMDISTModeldescritpion.xml`` which shows such a file is provided in the ``parser`` installation folder of CYMDISTPy. This template should be used and modify to create new XML input file.
