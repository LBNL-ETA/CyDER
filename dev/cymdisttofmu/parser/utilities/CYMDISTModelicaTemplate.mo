model {{model_name}}
  ...
  extends Modelica.Blocks.Interfaces.DiscreteBlock(
    startTime=0,samplePeriod=_communicationStepSize,
...
///////////// THE CODE BELOW HAS BEEN AUTOGENERATED //////////////   
  ...
  parameter Real _communicationStepSize=0 "Communication step size";
protected   
...
initial equation 
  ...
  assert(_communicationStepSize > 0,
    "Parameter _communicationStepSize: "
     + String(_communicationStepSize) + " must be set " +
     "to the communication step size of the FMU. " +
     "This must be done prior to " +
     "entering the initialization mode of the FMU.");
