within CYMDISTToFMU.Python34.Functions.Examples;
model CYMDIST "Test model for cymdist functions"
  ...
  external"C" osFla = detectOperatingSystem() annotation (IncludeDirectory="modelica://CYMDISTToFMU.Resources/C-Sources",
  ...
  parameter String pathToScript=Modelica.Utilities.Files.loadResource("modelica://CYMDISTToFMU/Resources/Python-Sources/testCYMDIST.py");
...
algorithm
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://CYMDISTToFMU.Resources/Scripts/Dymola/Python34/Functions/Examples/CYMDIST.mos"
        "Simulate and plot"),
