...
extensions = ['sphinx.ext.autodoc', 'mathjax', 'numfig']
...
project = u'CyDER Master Algorithm'
...
html_title = "CyDER Master Algorithm User Guide"
...
latex_documents = [
  ('index', 'userGuide.tex', u'CyDER Master Algorithm',
