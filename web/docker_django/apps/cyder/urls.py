...
urlpatterns = [
    ...
    url(r'^api/upmu/(?P<date_from>[^/]+)/(?P<date_to>[^/]+)/(?P<location>[^/]+)/$', views.upmu, name='upmu'),
    ...
    # ########
    url(r'^my_models/', views.my_models, name='my_models'),  # <<<<<< Remove
    url(r'^my_projects/', views.my_models, name='my_projects'),
    ...
    url(r'^my_project_settings/(?P<id>\d+)/$', views.my_models_general_settings, name='my_project_settings'),
    url(r'^my_project_model_add_devices/(?P<id>\d+)/$', views.my_models_add_devices, name='my_project_model_add_devices'),
    url(r'^my_project_model_settings/(?P<id>\d+)/$', views.my_models_settings, name='my_project_model_settings'),
    url(r'^my_project_model_scenarios/(?P<id>\d+)/$', views.my_models_scenarios, name='my_project_model_scenarios'),
    url(r'^my_project_review/(?P<id>\d+)/$', views.my_models_review, name='my_project_review'),
    # ########
